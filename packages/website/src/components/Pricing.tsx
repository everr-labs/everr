	...
	return (
		<section className="container py-24 lg:py-32">
			...
			<div className="mb-8 mt-16 flex items-center justify-center">
				...
				<Switch id="payment-schedule" defaultChecked />
			...
			{/* End Switch */}
			{/* Grid */}
			<div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-center lg:gap-0 lg:px-36">
				<Card>
					...
					<CardContent>
						<ul className="mt-7 space-y-2.5 text-sm">
							...
							<li className="flex space-x-2">
								<CheckIcon className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />
								<span className="text-muted-foreground">7 days retention</span>
							</li>
						</ul>
					</CardContent>
					<CardFooter>
				...
				<Card className="border-primary lg:scale-[1.1]">
					<CardHeader className="pb-2 text-center">
						<Badge className="mb-3 w-max self-center uppercase">
							Most popular
						</Badge>
						<CardTitle className="!mb-7">Growth</CardTitle>
					...
					<CardContent>
						<ul className="mt-7 space-y-2.5 text-sm">
							...
							<Feature>3 repositories</Feature>
							<Feature>500 pipelines/month</Feature>
						</ul>
					</CardContent>
					<CardFooter>
				...
				<Card>
					...
					<CardContent>
						<ul className="mt-7 space-y-2.5 text-sm">
							...
							<Feature>10 user</Feature>
							<Feature>Product support</Feature>
						</ul>
					</CardContent>
					<CardFooter>
						<Button className="w-full" variant={'outline'}>
