...
function CcRulesPage() {
  ...
  return (
    <div className="space-y-3">
      <CcConceptNote>
        A rule is a SQL query Clickety-Clack evaluates on a schedule. Each row
        it returns becomes an <strong>alert instance</strong>; if rows persist
        past the rule&rsquo;s <code>for</code> duration, the alert starts{" "}
        <strong>firing</strong>. Rules are defined as code and applied with{" "}
        <code>everr apply</code> — here you can inspect, test, and pause them.
      </CcConceptNote>
