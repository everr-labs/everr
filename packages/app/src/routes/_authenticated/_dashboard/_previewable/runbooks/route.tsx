...
/**
 * The master-detail frame every runbook renders in, the same shape the
 * dashboards frame uses: a 260px tinted, bordered rail as the first grid
 * column, and the open runbook as a pane that scrolls itself, so the page
 * never scrolls. The rail also carries the open runbook's pages, so reading a
 * runbook needs one navigation column, not two.
 */
