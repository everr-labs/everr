...
function draftToConfig(d: ConfigDraft): AlertingChannelConfig | null {
  switch (d.type) {
    case "webhook":
    case "slack":
    case "discord":
...
export function ChannelBuilder({
  ...
  const test = useMutation({
    mutationFn: (testedConfig: AlertingChannelConfig) =>
      testAlertingChannel({ data: { config: testedConfig } }),
