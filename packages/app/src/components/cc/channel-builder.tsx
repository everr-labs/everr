...
//
// Backs the /alerts/routing page's "Channels" section. A channel is a named,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <div className="space-y-4">
          <CcConceptNote>
            A channel is a named delivery endpoint that any number of receivers
            can reference. Secret fields (Slack URL, PagerDuty key, Telegram
            token) are write-only: the engine redacts them on read, and
            re-creating a channel under the same name rotates its secret in
            place.
          </CcConceptNote>
