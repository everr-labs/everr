...
function WhyObservabilityPage() {
  return (
    <div className="overflow-x-clip">
      <main>
        <section className="asterisk-hero asterisk-editorial">
          <div className="asterisk-inner">
            <p className="hero-intro">Why observability</p>
            <h1>
            ...
            <div className="asterisk-under">
              <div className="max-w-[720px]">
                <p className="text-[17px] leading-[1.6] text-muted-foreground">
                  Understand how your application performs, how it handles
                  traffic spikes, and why requests fail. Everr turns established
                  observability practices into a guided workflow, from
                  AI-assisted setup to everyday monitoring and investigation.
                </p>
              </div>
            ...
            <div className="mt-8 grid grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-16 max-[900px]:grid-cols-1 max-[900px]:gap-3">
              ...
              <div>
                <p className="text-[1.0625rem] leading-[1.65] text-muted-foreground">
                  Monitoring has established practices, and OpenTelemetry
                  provides a shared, vendor-neutral foundation for generating,
                  collecting, and exporting traces, metrics, and logs.
                </p>
                <p className={introClassName}>
                  The building blocks exist. Adopting them is where the work
                  begins.
                </p>
              </div>
            </div>
          ...
          <div className={sectionClassName}>
            ...
            <div className="mt-10 grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)] items-start gap-12 max-[700px]:grid-cols-1 max-[700px]:gap-6">
              <p className="max-w-[540px] leading-[1.65] text-muted-foreground">
                Those decisions take experience. Keeping them useful takes time.
                It is understandable to put monitoring off when getting value
                from it looks like a project of its own.
              </p>
        ...
        >
          <div className={sectionClassName}>
            ...
            <div className="mt-8 grid grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-16 max-[900px]:grid-cols-1 max-[900px]:gap-3">
              <h2
                className={sectionHeadingClassName}
                id="monitor-guidance-title"
              >
                You shouldn't have to become an observability expert to get
                useful answers.
              </h2>
              <p className="max-w-[550px] text-[1.0625rem] leading-[1.65] text-muted-foreground">
                Everr condenses years of observability experience into an
                opinionated getting-started flow. From AI-assisted
                instrumentation to dashboards and alerting, established
                practices guide the decisions that would otherwise be yours to
        ...
        <section className="border-t border-border">
          <div
            className={cn(wrapClassName, "py-28 text-center max-[700px]:py-20")}
          >
