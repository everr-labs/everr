...
CI cost is estimated **per job**: runner minutes, rounded up, times the runner type's per-minute rate. It is an estimate from runner usage, not a bill. To find and fix expensive CI, see [Cost Analysis](/docs/guides/cut-ci-cost).
