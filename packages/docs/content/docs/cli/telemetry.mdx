...
Everr ships bundled skills for agents that need telemetry and CI context:

- `everr-working-with-ci` explains how to use CI run, job, step, log, and historical test data.
