...
Everr estimates what your GitHub Actions runs cost you, so you can see where CI time and spend go. It's an estimate from runner usage, not a bill; this page explains the per-job model behind it. To find and fix expensive CI, see [Cost Analysis](/docs/ci-insights/cost-analysis).
...
This is the most common surprise in CI cost: a workflow that _feels_ fast can
