...
The hard part of a first alert is knowing what to alert on. Everr ships the `everr-setup-telemetry` skill; run this from the repository that emits the telemetry:
