...
The Agent inspects your telemetry, picks panels and queries that fit what you actually emit, writes the files, and validates them with `everr apply --dry-run`.
