...
The ```panel``` block is a full dashboard [Panel](/docs/reference/dashboard-spec), so swap the table and columns for whatever your telemetry uses.
...
See the [AlertRule spec](/docs/reference/alert-spec) for `spec.runbook` and every other field.
...
- **Guides**: [connect a repo](/docs/guides/setup-new-repo), [observability as code](/docs/concepts/observability-as-code), and [how alerts evaluate](/docs/concepts/how-alerts-evaluate).
- **Concepts**: [How Everr works](/docs).
- **Reference**: the [CLI](/docs/reference/cli), the [AlertRule spec](/docs/reference/alert-spec), and the [dashboard spec](/docs/reference/dashboard-spec).
