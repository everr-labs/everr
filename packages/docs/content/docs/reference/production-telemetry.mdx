...
<Callout title="Sending from browsers?">
  Telemetry sent straight from web pages needs a public, origin-bound API
  key. See [Browser telemetry](/docs/reference/browser-telemetry).
</Callout>
