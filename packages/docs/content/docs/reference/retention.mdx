...
| Signal | Free | Pro |
|---|---|---|
| Traces | 7 days | 90 days |
| Logs | 7 days | 90 days |
| Metrics | 14 days | 395 days (about 13 months) |

Each signal type is governed by its own retention window. On the Free plan, traces and logs roll off after 7 days, while metrics remain for 14 days. On the Pro plan, metrics remain for 395 days, long enough to compare current behavior against the same week or month last year. Traces and logs roll off after 90 days, where the per-event volume is much higher and the long-tail value is lower.
