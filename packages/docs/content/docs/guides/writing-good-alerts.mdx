...
A good alert is a query that stays quiet until a human should act. This rule fires one instance per service whose error rate exceeds 5% over 15 minutes — and stays quiet on tiny samples:
