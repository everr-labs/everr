...
export const LOGS_ATTRIBUTE_SOURCES_UI: AttributeSource[] = ["resource", "log", "scope"];
...
export const LOGS_EXCLUDED_KEYS: ReadonlySet<string> = new Set(["resource:service.name"]);
