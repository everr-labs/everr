---
name: spec
description: Shape Up feature design workflow. Creates shaping documents and a pitch with approval gates and mandatory refinement loops. No code is written.
---

# Shape Up Spec Skill

Use this skill when the user wants to design a feature. This workflow produces shaping documents and a pitch following the Shape Up methodology. **No implementation is done here.**

## Directory Structure

All artifacts live under `.specs/projects/{feature-name}/`:
...
After scopes are approved, run `bash scripts/update-tasks.sh` to keep TASKS.md current.
