...
| `routes`        | `id` (uuid PK), `tenant`, `matchers` (jsonb), `receiver`, `continue_matching`, `priority`, `group_by` (jsonb), `group_wait_secs`, `group_interval_secs`, `repeat_interval_secs` | Routing tree. |
