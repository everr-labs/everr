...
--
-- Alert history now comes from clickety-clack, which writes OTLP log records
-- straight to app.logs (ServiceName='alert', ScopeName='everr.alerting'). The
-- reader is packages/app/src/data/alerts/history.server.ts.
--
